...
\rowcolor{black} \mcn{27}{\color{white}\bf Round 4: Conference Finals} \\
\rowcolor{white}\\
...
VGK&&&&&&&&&&&&&&&&&&&&&&&&&&\\
WSH & \mr{VGK} & \mr{7} & \mr{WSH} & \mr{6} & \mr{WSH} & \mr{5} & \mr{WSH} & \mr{5} & \mr{VGK} & \mr{6} & \mr{VGK} & \mr{5} & \mr{VGK} & \mr{4} & \mr{VGK} & \mr{5} & \mr{VGK} & \mr{5} & \mr{WSH} & \mr{6} & \mr{WSH} & \mr{6} & \mr{VGK} & \mr{7} & \mr{WSH} & \mr{7}\\\hline
\rowcolor{white}\\
...
&7 & 3 & 4 & 5 & 6
    ...
    \vspace{-6cm}
    	\includegraphics[width=6in]{Points_round3.pdf}
	\end{wrapfigure}
    \end{minipage}
\end{table}
