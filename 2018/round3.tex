...
{\bf West} &&&&&&&&&&&&&&&&&&&&&&&&&&\\\hline
WPG&&&&&&&&&&&&&&&&&&&&&&&&&&\\
VGK & \mr{VGK} & \mr{6} & \mr{WPG} & \mr{6} & \mr{WPG} & \mr{5} & \mr{WPG} & \mr{6} & \mr{WPG} & \mr{6} & \mr{WPG} & \mr{7} & \mr{VGK} & \mr{5} & \mr{WPG} & \mr{6} & \mr{VGK} & \mr{6} & \mr{WPG} & \mr{6} & \mr{WPG} & \mr{6} & \mr{WPG} & \mr{4} & \mr{WPG} & \mr{7}\\\hline
&&&&&&&&&&&&&&&&&&&&&&&&&& \\
{\bf East} &&&&&&&&&&&&&&&&&&&&&&&&&&\\\hline
TBL&&&&&&&&&&&&&&&&&&&&&&&&&&\\
WSH & \mr{TBL} & \mr{6} & \mr{WSH} & \mr{5} & \mr{WSH} & \mr{5} & \mr{TBL} & \mr{6} & \mr{TBL} & \mr{6} & \mr{TBL} & \mr{5} & \mr{TBL} & \mr{6} & \mr{TBL} & \mr{7} & \mr{TBL} & \mr{5} & \mr{TBL} & \mr{6} & \mr{TBL} & \mr{7} & \mr{WSH} & \mr{7} & \mr{WSH} & \mr{6}\\\hline
\rowcolor{white}\\
...
&7 & 3 & 4 & 5 & 6
    ...
    \vspace{-6cm}
    	\includegraphics[width=6in]{Points_round2.pdf}
	\end{wrapfigure}
    \end{minipage}
\end{table}
